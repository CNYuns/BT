...
public.fastjson_list={}
public.fastjson_list["java.io.InputStream"]=true
public.fastjson_list["java.net.InetAddress"]=true
public.fastjson_list["java.net.Inet6Address"]=true
public.fastjson_list["java.net.InetSocketAddress"]=true
public.fastjson_list["java.net.URL"]=true
public.fastjson_list["org.dom4j.io.SAXContentHandler"]=true
public.fastjson_list["org.dom4j.io.XMLWriter"]=true
public.fastjson_list["org.python.antlr.ParseException"]=true
public.fastjson_list["java.lang.Character"]=true
public.fastjson_list["org.apache.xml.dtm.DTMConfigurationException"]=true
public.fastjson_list["javax.xml.transform.SourceLocator"]=true
public.fastjson_list["org.apache.xpath.objects.XNodeSetForDOM"]=true
public.fastjson_list["org.apache.xpath.NodeSet"]=true
public.fastjson_list["ognl.OgnlException"]=true
public.fastjson_list["ognl.Evaluation"]=true
public.fastjson_list["ognl.ASTMethod"]=true
public.fastjson_list["java.net.Inet4Address"]=true
public.fastjson_list["org.aspectj.org.eclipse.jdt.internal.compiler.env.ICompilationUnit"]=true
public.fastjson_list["org.aspectj.org.eclipse.jdt.internal.core.BasicCompilationUnit"]=true
public.fastjson_list["org.aspectj.org.eclipse.jdt.internal.compiler.lookup.SourceTypeCollisionException"]=true
public.fastjson_list["java.util.Locale"]=true
public.fastjson_list["org.codehaus.groovy.tools.javac.JavaStubCompilationUnit"]=true
public.fastjson_list["org.codehaus.groovy.control.CompilationFailedException"]=true
public.fastjson_list["java.lang.Exception"]=true
public.fastjson_list["org.codehaus.groovy.control.ProcessingUnit"]=true
public.fastjson_list["org.postgresql.jdbc.PgConnection"]=true
public.fastjson_list["com.sun.rowset.JdbcRowSetImpl"]=true
public.fastjson_list["java.lang.Class"]=true
public.fastjson_list["com.sun.org.apache.xalan.internal.xsltc.trax.TemplatesImpl"]=true
public.fastjson_list["org.apache.tomcat.dbcp.dbcp.BasicDataSource"]=true
public.fastjson_list["com.sun.org.apache.bcel.internal.util.ClassLoader"]=true
public.fastjson_list["java.lang.AutoCloseable"]=true
public.fastjson_list["sun.rmi.server.MarshalOutputStream"]=true
public.fastjson_list["java.util.zip.InflaterOutputStream"]=true
public.fastjson_list["java.io.FileOutputStream"]=true
public.fastjson_list["com.alibaba.fastjson.JSONObject"]=true
public.fastjson_list["org.apache.commons.io.input.ReaderInputStream"]=true
public.fastjson_list["org.apache.commons.io.input.CharSequenceReader"]=true
public.fastjson_list["java.lang.String"]=true
public.fastjson_list["org.apache.commons.io.output.WriterOutputStream"]=true
public.fastjson_list["org.apache.commons.io.output.FileWriterWithEncoding"]=true
public.fastjson_list["org.apache.commons.io.input.XmlStreamReader"]=true
public.fastjson_list["org.apache.commons.io.input.TeeInputStream"]=true
public.fastjson_list["java.util.Currency"]=true
public.fastjson_list["org.apache.commons.io.input.CharSequenceInputStream"]=true
public.fastjson_list["org.apache.commons.io.input.BOMInputStream"]=true
public.fastjson_list["jdk.nashorn.api.scripting.URLReader"]=true
public.fastjson_list["org.apache.commons.io.ByteOrderMark"]=true
public.fastjson_list["org.apache.commons.codec.binary.Base64InputStream"]=true
public.fastjson_list["org.eclipse.core.internal.localstore.SafeFileOutputStream"]=true
public.fastjson_list["com.mchange.v2.c3p0.WrapperConnectionPoolDataSource"]=true
public.fastjson_list["com.mysql.jdbc.ReplicationConnection"]=true
public.fastjson_list["com.mysql.jdbc.JDBC4Connection"]=true
public.fastjson_list["com.mysql.cj.jdbc.ha.LoadBalancedMySQLConnection"]=true
public.fastjson_list["com.mysql.cj.jdbc.ha.ReplicationMySQLConnection"]=true
public.fastjson_list["com.mysql.cj.jdbc.ha.LoadBalancedConnectionProxy"]=true
public.fastjson_list["com.mysql.cj.conf.url.ReplicationConnectionUrl"]=true

public.jackson_list={}
public.jackson_list['ch.qos.logback.core.db.DriverManagerConnectionSource']=true
public.jackson_list['com.zaxxer.hikari.HikariConfig']=true
public.jackson_list['org.apache.xbean.propertyeditor.JndiConverter']=true
public.jackson_list['br.com.anteros.dbcp.AnterosDBCPConfig']=true
public.jackson_list['com.sun.org.apache.xalan.internal.xsltc.trax.TemplatesImpl']=true
public.jackson_list['org.springframework.context.support.ClassPathXmlApplicationContext']=true
public.jackson_list['org.jdom2.transform.XSLTransformer']=true
public.jackson_list['org.springframework.context.support.FileSystemXmlApplicationContext']=true
public.jackson_list['com.newrelic.agent.deps.ch.qos.logback.core.db.JNDIConnectionSource']=true
public.jackson_list['oadd.org.apache.xalan.lib.sql.JNDIConnectionPool']=true
public.jackson_list['com.sun.org.apache.xalan.internal.lib.sql.JNDIConnectionPool']=true
public.jackson_list['org.jsecurity.realm.jndi.JndiRealmFactory']=true
public.jackson_list['br.com.anteros.dbcp.AnterosDBCPDataSource']=true
public.jackson_list['com.pastdev.httpcomponents.configuration.JndiConfiguration']=true
public.jackson_list['oadd.org.apache.commons.dbcp.cpdsadapter.DriverAdapterCPDS']=true
public.jackson_list['org.apache.commons.dbcp2.cpdsadapter.DriverAdapterCPDS']=true
public.jackson_list['org.apache.tomcat.dbcp.dbcp.cpdsadapter.DriverAdapterCPDS']=true
public.jackson_list['org.apache.tomcat.dbcp.dbcp2.cpdsadapter.DriverAdapterCPDS']=true
public.jackson_list['org.apache.tomcat.dbcp.dbcp.datasources.PerUserPoolDataSource']=true
public.jackson_list['com.newrelic.agent.deps.ch.qos.logback.core.db.DriverManagerConnectionSource']=true
...
function public.get_num_procs()
    ...
    for line in file:lines() do
        local processor = line:match("^processor[%s]+:%s+(%d+)")
        if processor then
            coreCount = coreCount + 1
        end
    end
    if coreCount==0 then return 1 end 
    file:close()
    return coreCount
end

-- 返回MB 内存大小
function public.get_memory_size()
    local file = io.open("/proc/meminfo", "r")
    if not file then
        return 1024
    end
    local memTotal = 1024000
    for line in file:lines() do
        local key, value = line:match("^(%w+):[%s]+(%d+)%s+kB$")
        if key == "MemTotal" then
            memTotal = tonumber(value)
            break
        end
    end
    file:close()
...
function public.getMicroseconds()
    local tv = ffi.new("struct timeval")
    ffi.C.gettimeofday(tv, nil)
...
function public.measureTime(func,name)
    ...
    local startTime = public.getMicroseconds()
    for i=1,1000 do
        func()
    end 
    local endTime = public.getMicroseconds()
    local elapsedTime = endTime - startTime
    public.logs("函数:"..name.." 执行1000次的时间为: "..tostring(elapsedTime).." 微秒")
    return elapsedTime
end
...
-- @param ip ip地址
-- @return true or false
function public.is_in_addr_ipv4(ip)
    local ipv4_addr = ffi.new("in_addr")
...
function public.is_ip(ip)
    -- 判断长度
    if #ip<10 then return false end
    if public.is_in_addr_ipv4(ip) then
        return true
    end
...
function public.ip_count_check()
    if not ngx.ctx.site_cc then return false end
    ...
    local ip=ngx.ctx.ip
    local token=ip.."|"..ngx.ctx.server_name
    local ipcount=ngx.shared.spider:get(token)
    if not ipcount then return false end    
    if  BTWAF_RULES.load_spider:match(ngx.ctx.ip) then 
        ngx.shared.spider:set(ngx.ctx.ip, "1",18000)
        return true 
    end 
    local cc_ip_max=5000 
    if ngx.ctx.cc_ip_max>5000 then cc_ip_max=ngx.ctx.cc_ip_max end
    local tmp_ip_count=0
    local tmp_traffic=0
    local token_data=ngx.shared.ip:get(token)	
    if token_data then 
        token_data=Public.split(token_data,"|")
        if token_data~=nil then 
            if Public.arrlen(token_data)>2 then  
                local ip_tmp_count_tmp=tonumber(token_data[1])
                if ip_tmp_count_tmp then
                    tmp_ip_count=ip_tmp_count_tmp
                end
                local tmp_traffic_tmp=tonumber(token_data[3])
                if tmp_traffic_tmp then
                    tmp_traffic=tmp_traffic_tmp
                end
            end 
        end
    end
    ipcount=ipcount+tmp_ip_count
    if ipcount>cc_ip_max then
		...
		msg=msg.." (包括所有静态资源) 如需要调整阈值请到CC防御中设置单IP防御"
		IpInfo.write_log('cc',msg)
		IpInfo.write_drop_ip('cc',lock_time,msg)
    end
    if ngx.ctx.cc_ip_traffic~=nil and  type(ngx.ctx.cc_ip_traffic)=='number' then 
        local traffic=ngx.shared.spider:get(token.."|traffic")
        if traffic then
            traffic=tonumber(traffic)
            traffic=traffic+tmp_traffic
            if ngx.ctx.cc_ip_traffic<50 then ngx.ctx.cc_ip_traffic=50 end 
            if traffic/1024/1024 >ngx.ctx.cc_ip_traffic then 
                local safe_count,_ = ngx.shared.drop_sum:get(ip)
                if not safe_count then
                    ngx.shared.drop_sum:set(ip,2,86400)
                    safe_count = 1
                ...
                IpInfo.bt_ip_filter(ip,lock_time)
                ngx.ctx.is_type='cc'
                local msg="单IP防护"..'当天内流量累计超过'..ngx.ctx.cc_ip_traffic..'M,封锁' .. lock_time .. '秒'
                msg=msg.." (包括所有静态资源) 如需要调整阈值请到CC防御中设置单IP防御"
                IpInfo.write_log('cc',msg)
                IpInfo.write_drop_ip('cc',lock_time,msg)
            end 
...
function public.is_static()
    if ngx.ctx.method=="GET" then 
        ...
        if ngx.shared.btwaf_data:get(ngx.md5(ngx.ctx.url_split)) then
            if ngx.ctx.cc_ip_max_status==true then public.ip_count_check() end 
            return true
        end
        if  ngx.re.find(ngx.ctx.url_split,"\\.(js|css|gif|jpg|jpeg|png|bmp|swf|ico|woff|woff2|webp|mp4|mp3)$","isjo") and not ngx.re.find(ngx.ctx.url_split, "%",'jo')  then 
            ngx.shared.btwaf_data:set(ngx.md5(ngx.ctx.url_split), 1, 1200)
            return true
        end
    end
    if ngx.ctx.cc_ip_max_status==true then public.ip_count_check() end
...
function public.get_today_start_time_logs()
    local date_time = os.date("*t")
    date_time.hour = 0
    date_time.min = 0
    date_time.sec = 0
    return os.time(date_time)
end

-- 获取今天结束时间戳
-- @return timestamp int 时间戳
function public.get_today_end_time_logs()
    return public.get_today_start_time_logs() + 86400
end
...
function public.insert_request_total()
    ...
    local lock = public.is_lock_end(lock_key,40)
    if not lock then
        return
    end
...
function public.generate_random_int(length)
...
function public.iconv_to_utf_8(body)
    local ok2,iconv = pcall(function()
    	return require "iconv"
    end)
    if not ok2 then return body end 
...
function public.timeout_count()
    ...
    local function websocket_handler()
        ...
        if not ok then
            new_total_connections = decr("total_connections", 1, 0)
...
function public.get_fix(filename_str)
    -- 找到第一个.的位置 如果没有点则直接返回原字符串
    for i = 1, #filename_str, 1 do
        if filename_str:sub(i, i) == '.' then
            return filename_str:sub(i)
        end
    end
    return filename_str
end

function public.is_fastjson_very(value) 
    if ngx.ctx.fastjson~=nil and ngx.ctx.fastjson==true then return end 
    if type(value)=='string' then 
       if  public.fastjson_list[value]==true then 
           ngx.ctx.fastjson=true
        end 
    end 
end 

-- 解析并展开嵌套的JSON参数，将其转换为扁平的表，保留完整的键路径
-- @param json_args table 包含嵌套JSON参数的表
-- @param t table (可选) 用于存储解析结果的表，默认为空表
-- @param prefix string (可选) 当前处理的键路径前缀
-- @return table 转换后的扁平表，键名保留完整路径
function public.process_json_args_ret(json_args, t, prefix)
    -- 如果传入的json_args不是表类型，返回一个空表
    if type(json_args) ~= "table" then
        return {}
    end
    local t = t or {} -- 存储解析结果的表
    local prefix = prefix or "" -- 键路径前缀，默认为空
    
    -- 遍历json_args的键值对
    for k, v in pairs(json_args) do
	    if type(v)=='string' and #v>5 and public.jackson_list[v]==true then ngx.ctx.jackson=true end
        if k=="@type" then public.is_fastjson_very(v) end 
        if k=="4074797065" then public.is_fastjson_very(v) k="@type" end 
        if k=="\\u0040\\u0074\\u0079\\u0070\\u0065" then public.is_fastjson_very(v) k="@type" end 
        if k=="\\x40\\u0074\\u0079\\u0070\\u0065" then public.is_fastjson_very(v) k="@type" end 
        local current_key = prefix
        if prefix ~= "" then
            current_key = prefix .. "." .. k
        else
            current_key = k
        end
        ...
        if type(v) == "table" then
            -- 对于嵌套表，递归处理并传递当前键路径
            public.process_json_args_ret(v, t, current_key)
        else
            -- 对于非表值，直接存储到结果表中，使用完整键路径
            if type(t[current_key]) == "table" then
                table.insert(t[current_key], v)
            elseif t[current_key] ~= nil then
                local tmp = {}
                table.insert(tmp, t[current_key])
                table.insert(tmp, v)
                t[current_key] = tmp
            else
                t[current_key] = v
...
function public.insert_url_count()
    local lock_key = 'public.insert_url_count'
    ngx.sleep(1)
    local lock = public.is_lock_end(lock_key,40)
    if not lock then
        return
    end
    Database.url_total_insert()
end



function public.insert_ip_count()
    local lock_key = 'public.insert_ip_count'
    ngx.sleep(1)
    local lock = public.is_lock_end(lock_key,40)
    if not lock then
        return
    end
    Database.ip_total_insert()
end

function public.get_total_report_hour()
    local lock_key = 'public.get_total_report_hour'
    ngx.sleep(1)
    local lock = public.is_lock_end(lock_key,40)
    if not lock then
        return
    end
    Database.get_total_report_hour()
end


function public.get_end_fix(filename_str)
    -- 找到第一个.的位置 如果没有点则直接返回原字符串
...
function public.check_server_name_session()
    if ngx.var.cookie_server_name_session==nil then return 0 end
    local session=ngx.var.cookie_server_name_session
    if session and type(session)=="string" and  #session==32 then return 1 end 
    return 0
end
