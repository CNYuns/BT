...
class main(Base):
    ...
    def get_status(self, get):
        '''
            @name 获取防火墙状态
            @author MissChina <2024/3/26 下午 3:40>
    ...
    def check_port_exist(self, get):
        '''
            ...
            @author MissChina <2024/5/13 下午3:51>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def get_port_db(self, get):
        '''
            @name 从数据库中获取端口规则列表
            @author MissChina <2024/3/26 下午 6:13>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        try:
    ...
    def get_ip_db(self, get):
        '''
            @name 从数据库中获取ip规则列表
            @author MissChina <2024/3/26 下午 11:53>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        try:
    ...
    def get_forward_db(self, get):
        '''
            ...
            @author MissChina <2024/3/26 下午 11:58>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        try:
    ...
    def structure_port_return_data(self, list_port, rule_db, get):
        '''
            @name 构造返回数据
            @author MissChina <2024/3/26 下午 10:47>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def structure_forward_return_data(self, list_forward, rule_db, get):
        '''
            @name 构造端口转发规则返回数据
            @author MissChina <2024/3/27 上午 12:11>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def port_rules_list(self, get):
        '''
            @name 获取所有端口规则列表
            @author MissChina <2024/3/25 上午 11:06>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return list[dict{}...]
        '''
    ...
    def export_rules(self, get):
        '''
            @name 导出规则
            @author MissChina <2024/3/26 下午 3:17>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def export_port_rules(self, get):
        '''
            @name 导出所有端口规则
            @author MissChina <2024/3/26 下午 2:39>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.chain = get.get('chain/s', 'all')
    ...
    def import_port_rules(self, get):
        '''
            @name 导入端口规则
            @author MissChina <2024/3/26 下午 2:58>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def set_nline_port_ip(self, get):
        '''
            ...
            @author MissChina <2024/3/26 上午 9:32>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def set_range_port_ip(self, get):
        '''
            ...
            @author MissChina <2024/3/26 上午 9:35>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def set_port_rule(self, get):
        '''
            @name 设置端口规则
            @author MissChina <2024/3/25 下午 6:28>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def more_prot_rule(self, get):
        '''
            @name 处理多个ip的端口规则情况
            @author MissChina <2024/3/29 下午 4:02>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        if get.port.find(",") != -1:
    ...
    def exec_port_rule(self, get):
        '''
            @name 执行端口设置
            @author MissChina <2024/3/28 下午 6:29>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def check_ips(self, get):
        '''
            @name 前置检测ip是否合法
            @author MissChina <2024/5/14 上午10:40>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        if get.address != "all" and "\n" in get.address:
    ...
    def modify_port_rule(self, get):
        '''
            @name 修改端口规则
            @author MissChina <2024/3/27 上午 9:38>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def set_domain_port_rule(self, get):
        '''
            @name 设置域名端口规则
            @author MissChina <2024/3/26 下午 5:11>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        # 2024/4/17 下午4:47 检查防火墙状态，如果未启动则不允许设置规则
    ...
    def add_port_db(self, get, protocol, addtime, domain):
        '''
            @name 添加端口规则到指定数据库
            @author MissChina <2024/5/13 下午4:46>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def set_ip_db(self, get):
        '''
            @name 添加/删除数据库的ip规则
            @author MissChina <2024/3/26 下午 11:24>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        if get.operation == "add":
    ...
    def set_forward_db(self, get):
        '''
            ...
            @author MissChina <2024/3/26 下午 11:40>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        if get.operation == "add":
    ...
    def output_port(self, get):
        '''
            @name 出站端口规则
            @author MissChina <2024/3/25 下午 6:56>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        info = {
    ...
    def set_nline_ip_rule(self, get):
        '''
            ...
            @author MissChina <2024/3/26 上午 9:40>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        address = get.address.split("\n")
    ...
    def set_range_ip_rule(self, get):
        '''
            @name 处理192.168.1.10-192.168.1.20这种范围ip的添加/删除
            @author MissChina <2024/3/26 上午 9:43>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        address = self.firewall.handle_ip_range(get.address)
    ...
    def set_mask_ip_rule(self, get):
        '''
            @name 设置带掩码的ip段
            @author MissChina <2024/3/26 上午 9:47>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def check_is_user_ip(self, get):
        '''
            @name
            @author MissChina <2024/4/9 下午11:31>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def set_ip_rule(self, get):
        '''
            @name 设置ip规则
            @author MissChina <2024/3/25 下午 7:16>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        # 2024/4/17 下午4:47 检查防火墙状态，如果未启动则不允许设置规则
    ...
    def set_domain_ip_rule(self, get):
        '''
            @name 设置域名ip规则
            @author MissChina <2024/3/26 下午 5:19>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.operation = get.get('operation/s', 'add')
