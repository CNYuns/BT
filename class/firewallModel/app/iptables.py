...
class Iptables(Base):
    ...
    def status(self):
        '''
            @name 获取系统防火墙的运行状态
            @author MissChina <2024/3/19 下午 5:00>
    ...
    def restart(self):
        '''
            @name 重启防火墙
            @author MissChina <2024/3/19 下午 4:59>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def parse_rules(self, stdout):
        '''
            ...
            @author MissChina <2024/3/19 下午 3:53>
                字段含义:
    ...
    def list_rules(self, parm):
        '''
            @name 列出指定表的指定链的规则
            @author MissChina <2024/3/19 下午 3:02>
            @param
            @return
        '''
        try:
    ...
    def get_chain_port(self, chain):
        '''
            @name 根据链来获取端口规则
            @author MissChina <2024/4/29 下午3:29>
    ...
    def get_chain_data(self, chain):
        '''
            @name 获取指定链的数据
            @author MissChina <2024/4/29 下午4:01>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        try:
    ...
    def list_address(self):
        '''
            @name 列出防火墙中所有的ip规则
            @author MissChina <2024/4/29 下午2:47>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return
        '''
        try:
    ...
    def list_input_address(self):
        '''
            ...
            @author MissChina <2024/4/29 下午2:48>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        try:
    ...
    def list_output_address(self):
        '''
            ...
            @author MissChina <2024/4/29 下午2:49>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        try:
    ...
    def input_port(self, info, operation):
        '''
            @name 添加INPUT端口规则
            @author MissChina <2024/4/29 下午2:50>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        try:
    ...
    def set_chain_port(self, info, operation, chain):
        '''
            @name 添加/删除指定链的端口规则
            @author MissChina <2024/4/29 下午4:49>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        try:
    ...
    def rich_rules(self, info, operation):
        '''
            @name
            @author MissChina <2024/4/29 下午2:51>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        try:
    ...
    def flush_chain(self, chain_name):
        '''
            @name 清空指定链中的所有规则
            @author MissChina <2024/3/19 下午 3:03>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        try:
    ...
    def list_port_forward(self):
        '''
            @name 获取所有端口转发列表
            @author MissChina <2024/4/29 下午5:55>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
