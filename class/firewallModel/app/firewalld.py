...
class Firewalld(Base):
    ...
    def status(self) -> bool:
        '''
            @name 获取防火墙状态
            @author MissChina <2024/3/20 下午 12:01>
    ...
    def version(self) -> str:
        '''
            @name 获取防火墙版本号
            @author MissChina <2024/3/20 下午 12:00>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def start(self) -> dict:
        '''
            @name 启动防火墙
            @author MissChina <2024/3/20 下午 12:08>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def stop(self) -> dict:
        '''
            @name 停止防火墙
            @author MissChina <2024/3/20 下午 12:10>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def restart(self) -> dict:
        '''
            @name 重启防火墙
            @author MissChina <2024/3/20 下午 12:11>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def list_port(self) -> list:
        '''
            @name 获取所有防火墙端口列表
            @author MissChina <2024/3/20 下午 12:12>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def list_address(self) -> list:
        '''
            ...
            @author MissChina <2024/3/20 下午 2:45>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def input_port(self, info: dict, operation: str) -> dict:
        '''
            @name 添加或删除防火墙端口
            @author MissChina <2024/3/20 下午 5:34>
    ...
    def rich_rules(self, info: dict, operation: str) -> dict:
        '''
            @name 添加或删除复杂规则
            @author MissChina <2024/3/22 上午 11:35>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        if operation not in ["add", "remove"]:
    ...
    def parse_public_zone(self) -> dict:
        '''
            ...
            @author MissChina <2024/3/22 下午 12:22>
            @param "data":{"参数名":""} <数据类型> 参数描述
    ...
    def parse_direct_xml(self) -> dict:
        '''
            ...
            @author MissChina <2024/3/22 下午 2:32>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return list[dict{}...]
        '''
        try:
