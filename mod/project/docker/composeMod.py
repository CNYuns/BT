...
def check_file(func):
    '''
        @name 检查相同传参的装饰器
        @author MissChina <2024/6/25 下午2:30>
...
class main(Compose):
    ...
    def exec_cmd(self, get, command):
        '''
            ...
            @author MissChina <2024/6/25 下午2:41>
    ...
    def stop(self, get):
        '''
            ...
            @author MissChina <2024/6/24 下午10:54>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.option = "停止"
    ...
    def ps(self, get):
        '''
            ...
            @author MissChina <2024/6/26 下午8:38>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.path = get.get("path/s", None)
    ...
    def get_config(self, get):
        '''
            ...
            @author MissChina <2024/6/26 下午9:25>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        if self.def_name is None: self.set_def_name(get.def_name)
    ...
    def check_config(self, get):
        '''
            ...
            @author MissChina <2024/6/27 上午10:26>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def create(self, get):
        '''
            ...
            @author MissChina <2024/6/27 上午10:07>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        if self.def_name is None: self.set_def_name(get.def_name)
    ...
    def delete(self, get):
        '''
            ...
            @author MissChina <2024/6/27 上午11:42>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        if self.def_name is None: self.set_def_name(get.def_name)
    ...
    def get_project_container_logs(self, get):
        '''
            ...
            @author MissChina <2024/6/28 下午3:16>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
