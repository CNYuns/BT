...
server {{
    ...
    def structure_proxy_conf(self, get):
        '''
            @name
            @author MissChina <2024/4/19 下午4:29>
    ...
    def structure_nginx(self, get):
        '''
            @name 构造反向代理的配置文件
            @author MissChina <2024/4/18 上午10:54>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def write_nginx_conf(self, get):
        '''
            @name 写入Nginx配置文件
            @author MissChina <2024/4/18 上午10:36>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        # 这里可能会报错
    ...
    def check_http3_support(self):
        '''
            ...
            @author MissChina <2024/4/25 上午11:13>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def check_before_create(self, get):
        '''
            @name 添加反代前置配置检测
            @author MissChina <2024/7/29 下午3:01>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def create_must_dir(self, get):
        '''
            @name
            @author MissChina <2024/7/29 下午2:40>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def check_after_create(self, get):
        '''
            @name 创建完成后置检测
            @author MissChina <2024/7/29 上午11:47>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        wc_err = public.checkWebConfig()
    ...
    def insert_sites(self, get):
        '''
            ...
            @author MissChina <2024/7/29 上午11:32>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def create(self, get):
        '''
            @name 创建反向代理
            @author MissChina <2024/4/18 上午9:27>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def read_json_conf(self, get):
        '''
            @name
            @author MissChina <2024/4/18 下午9:53>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def set_global_log(self, get):
        '''
            @name
            @author MissChina <2024/4/18 下午9:58>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def add_dir_auth(self, get):
        '''
            ...
            @author MissChina <2024/4/22 下午4:17>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name", "")
    ...
    def del_dir_auth(self, get):
        '''
            ...
            @author MissChina <2024/4/23 上午9:35>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name", "")
    ...
    def set_global_websocket(self, get):
        '''
            @name
            @author MissChina <2024/4/19 下午2:37>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name", "")
    ...
    def add_proxy(self, get):
        '''
            @name
            @author MissChina <2024/4/19 下午3:00>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name", "")
    ...
    def delete(self, get):
        '''
            @name
            @author MissChina <2024/4/19 下午9:45>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name", "")
    ...
    def batch_delete(self, get):
        '''
            @name 批量删除站点
            @author MissChina <2024/5/28 上午9:51>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def get_site_ssl_info(self, siteName):
        '''
            @name 获取证书的部署状态
            @author MissChina <2024/4/26 下午4:58>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        try:
    ...
    def add_domain(self, get):
        '''
            @name
            @author MissChina <2024/4/19 下午11:46>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name", "")
    ...
    def del_domain(self, get):
        '''
            @name
            @author MissChina <2024/4/20 上午12:07>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.id = get.get("id", "")
    ...
    def get_config(self, get):
        '''
            @name
            @author MissChina <2024/4/20 下午2:22>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name", "")
...
{server_block}'''.format(
    ...
    def set_cert(self, get):
        '''
            @name
            @author MissChina <2024/4/21 下午10:46>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.oid = get.get("oid", "")
    ...
    def close_ssl(self, get):
        '''
            @name
            @author MissChina <2024/4/21 下午11:04>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name", "")
    ...
    def set_ssl(self, get):
        '''
            @name 保存指定网站的SSL证书
            @author MissChina <2024/4/21 下午11:12>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name", "")
    ...
    def set_test_cert(self, get):
        '''
            @name
            @author MissChina <2024/4/21 下午11:30>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name", "")
    ...
    def apply_cert_api(self, get):
        '''
            @name
            @author MissChina <2024/4/21 下午11:34>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name", "")
    ...
    def apply_dns_auth(self, get):
        '''
            @name
            @author MissChina <2024/4/21 下午11:36>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def SetBatchCertToSite(self, get):
        '''
            @name
            @author MissChina <2024/4/21 下午11:44>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name", "")
    ...
    def CreateRedirect(self, get):
        '''
            @name
            @author MissChina <2024/4/22 上午10:27>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name", "")
    ...
    def DeleteRedirect(self, get):
        '''
            @name 删除指定网站的某个重定向规则
            @author MissChina <2024/4/22 上午10:45>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name", "")
    ...
    def ModifyRedirect(self, get):
        '''
            @name 编辑指定网站的某个重定向规则
            @author MissChina <2024/4/23 上午10:38>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name", "")
    ...
    def GetRedirectFile(self, get):
        '''
            ...
            @author MissChina <2024/4/26 下午3:32>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def SetSecurity(self, get):
        '''
            @name 设置防盗链
            @author MissChina <2024/4/22 上午11:12>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name", "")
    ...
    def add_ip_limit(self, get):
        '''
            @name 添加全局IP黑白名单
            @author MissChina <2024/4/23 下午3:08>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name", "")
    ...
    def del_ip_limit(self, get):
        '''
            @name 删除全局IP黑白名单
            @author MissChina <2024/4/23 下午3:12>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name", "")
    ...
    def batch_del_ip_limit(self, get):
        '''
            @name 批量删除全局IP黑白名单
            @author MissChina <2024/4/23 下午3:14>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name", "")
    ...
    def get_proxy_list(self, get):
        '''
            @name
            @author MissChina <2024/4/22 下午9:02>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name", "")
    ...
    def get_global_conf(self, get):
        '''
            @name 获取指定网站的所有配置信息
            @author MissChina <2024/4/23 上午11:16>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name", "")
    ...
    def set_url_proxy(self, get):
        '''
            @name
            @author MissChina <2024/4/22 下午9:04>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name", "")
    ...
    def add_url_ip_limit(self, get):
        '''
            ...
            @author MissChina <2024/4/22 下午10:16>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name", "")
    ...
    def batch_del_url_ip_limit(self, get):
        '''
            ...
            @author MissChina <2024/4/24 上午11:22>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name", "")
    ...
    def set_url_custom_conf(self, get):
        '''
            ...
            @author MissChina <2024/4/24 上午9:58>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name", "")
    ...
    def GetSiteLogs(self, get):
        '''
            @name 获取指定网站的网站日志
            @author MissChina <2024/4/24 下午5:39>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name", "")
    ...
    def clear_cache(self, get):
        '''
            @name 清理指定网站的反向代理缓存
            @author MissChina <2024/4/25 上午10:51>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name", "")
    ...
    def set_https_port(self, get):
        '''
            @name 设置指定网站的https端口
            @author MissChina <2024/4/25 下午9:24>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name", "")
    ...
    def update_conf(self, get):
        '''
            @name
            @author MissChina <2024/4/23 下午2:13>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
