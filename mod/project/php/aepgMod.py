...
class main():
    ...
    def get_php_config(self, get):
        '''
            ...
            @author MissChina <2024/5/6 上午10:40>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def get_env_info(self, get):
        '''
            @name 获取环境信息
            @author MissChina <2024/5/8 下午4:31>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def get_path_permission(self, get):
        '''
            @name 获取指定目录的权限信息
            @author MissChina <2024/5/6 下午3:51>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        try:
    ...
    def set_path_permission(self, get):
        '''
            @name 为指定目录设置权限
            @author MissChina <2024/5/6 下午3:52>
    ...
    def get_os_type(self):
        '''
            @name 获取系统类型
            @author MissChina <2024/5/6 下午5:02>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def install_env_soft(self, get):
        '''
            @name 安装指定运行环境
            @author MissChina <2024/5/6 下午4:55>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def backup_database(self, get):
        '''
            @name 备份指定数据库为sql文件
            @author MissChina <2024/5/7 上午10:28>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def backup_rewrite(self, get):
        '''
            @name 备份指定网站的伪静态
            @author MissChina <2024/5/7 下午5:41>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name/s", "")
    ...
    def restore_rewrite(self, get):
        '''
            ...
            @author MissChina <2024/5/9 下午2:20>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        self._rewrite_file = self._rewrite_file.format(panel_path=public.get_panel_path(), site_name=get.site_name)
    ...
    def restore_upload_rewrite(self, get):
        '''
            ...
            @author MissChina <2024/5/9 下午6:05>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        self._rewrite_file = self._rewrite_file.format(panel_path=public.get_panel_path(), site_name=get.site_name)
    ...
    def get_db_config_file(self, get):
        '''
            ...
            @author MissChina <2024/5/8 上午9:45>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def update_package_conf(self, get):
        '''
            @name 更新json配置文件
            @author MissChina <2024/5/7 下午6:32>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def tar_package(self, get):
        '''
            @name 将所有数据打包成一个压缩包
            @author MissChina <2024/5/8 上午10:06>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def update_database(self, get):
        '''
            @name 更新数据库
            @author MissChina <2024/5/8 下午3:34>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def update_upload_database(self, get):
        '''
            @name 更新上传应用包的数据库
            @author MissChina <2024/5/9 下午4:43>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def create(self, get):
        '''
            @name 创建一件应用环境包
            @author MissChina <2024/5/6 上午10:50>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name/s", "")
    ...
    def get_db_all_result(self, get):
        '''
            ...
            @author MissChina <2024/5/9 上午10:42>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def get_db_result(self, get):
        '''
            ...
            @author MissChina <2024/5/9 上午11:03>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def get_upload_db_all_result(self, get):
        '''
            @name 返回上传数据库中所有的数据
            @author MissChina <2024/5/9 下午5:15>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def get_upload_db_result(self, get):
        '''
            @name 返回上传数据库中指定包的数据
            @author MissChina <2024/5/9 下午5:19>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def get_list(self, get):
        '''
            @name 获取所有的应用包列表
            @author MissChina <2024/5/9 上午10:40>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name/s", "")
    ...
    def get_package_conf(self, get):
        '''
            ...
            @author MissChina <2024/5/9 上午11:18>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        try:
    ...
    def check_php_mysql(self, get):
        '''
            ...
            @author MissChina <2024/5/9 下午3:10>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.version = public.get_site_php_version(get.site_name)
    ...
    def set_php_disable(self, get):
        '''
            ...
            @author MissChina <2024/5/9 下午3:07>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def install_phplib(self, get):
        '''
            ...
            @author MissChina <2024/5/9 下午3:08>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def copy_upload_site(self, get):
        '''
            ...
            @author MissChina <2024/5/9 下午5:52>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def import_init_sql(self, get):
        '''
            ...
            @author MissChina <2024/5/9 下午3:09>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def import_upload_init_sql(self, get):
        '''
            ...
            @author MissChina <2024/5/9 下午6:08>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.db_info = public.M('databases').where('pid=?', (get.site_info['id'],)).find()
    ...
    def apply_site(self, get):
        '''
            ...
            @author MissChina <2024/5/9 上午10:55>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
        get.site_name = get.get("site_name/s", "")
    ...
    def upload_package(self, get):
        '''
            @name 上传应用包到指定位置
            @author MissChina <2024/5/9 下午3:51>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def get_upload_list(self, get):
        '''
            @name 获取上传列表的所有包数据
            @author MissChina <2024/5/9 下午5:13>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"status":True/False,"msg":"提示信息"}
        '''
    ...
    def get_upload_result(self, get):
        '''
            @name 获取上传列表中某一个包的数据
            @author MissChina <2024/5/9 下午6:33>
            @param "data":{"参数名":""} <数据类型> 参数描述
            @return dict{"sbt 2
